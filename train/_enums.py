...
MAX_EMBLEM_SLOTS = 2  # src/classes/gamestate.h
KNOWN_TOP_LIBRARY_SIZE = 5  # src/classes/game.h
STATE_SIZE = 6516  # src/machine_io.h
...
GY_SLOT_SIZE = 4  # src/machine_io.h
EXILE_SLOT_SIZE = 5  # src/machine_io.h
ZONE_CARD_ID_OFF = 0  # src/machine_io.h
ZONE_PLAYABLE_SELF_OFF = 1  # src/machine_io.h
ZONE_PLAYABLE_OPP_OFF = 2  # src/machine_io.h
ZONE_EXPIRES_OFF = 3  # src/machine_io.h
EXILE_COUNTERS_OFF = 4  # src/machine_io.h
ZONE_COUNTER_NORMALIZER = 10  # src/machine_io.h
...
EXTRAS_SCALARS = 12  # src/machine_io.h
EXTRAS_PRIORITY_SIZE = 3  # src/machine_io.h
EXTRAS_MULLIGAN_SIZE = 3  # src/machine_io.h
MULLIGAN_NORMALIZER = 7  # src/machine_io.h
EXTRAS_SB_CTX_SIZE = 3  # src/machine_io.h
DECKLIST_SLOT_SIZE = 2  # src/machine_io.h
OPP_DECKLIST_SLOT_SIZE = 3  # src/machine_io.h
OPP_DECKLIST_REVEALED_OFF = 2  # src/machine_io.h
MANA_DEV_COLORS = 6  # src/machine_io.h
MANA_DEV_SELF_SIZE = 10  # src/machine_io.h
MANA_DEV_OPP_SIZE = 9  # src/machine_io.h
...
PER_TURN_COUNT_FIELDS = 6  # src/machine_io.h
...
PLAYER_EFFECTS_FLAGS = 10  # src/machine_io.h
PLAYER_EFFECTS_PLAYER_SIZE = 13  # src/machine_io.h
